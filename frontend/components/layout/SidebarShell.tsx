        ...
        <div className="min-h-screen bg-slate-100">
            <div className="mx-auto flex w-full max-w-[1440px] gap-4 px-4 py-8 sm:px-6 lg:px-8">
                ...
                <div className="min-w-0 flex-1">
                    <div className="fixed top-0 left-0 right-0 z-10 m-4 flex items-center justify-between rounded-2xl border border-slate-200 bg-white px-3 py-2 shadow-sm lg:hidden">
                        <button
                            type="button"
